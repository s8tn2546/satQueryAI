...
interface AuthFormProps {
  ...
  onClose?: () => void;
  /**
   * Callback triggered when a valid login/signup submit is initiated
   */
  onSubmit?: () => void;
  /**
 ...
 * Themed for Glassmorphism Onboarding UX.
 */
export function AuthForm({
  ...
  // Load saved email after hydration (client-only, avoids SSR hydration mismatch)
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Signal parent (e.g. show full-screen loading) for login/signup actions
    onSubmit?.();
  ...
  const renderAuthContent = () => {
      ...
      return (
        <div className="space-y-4 animate-in fade-in-50 slide-in-from-right-5">
          <div className="text-center mb-6">
            <KeyRound className="h-12 w-12 text-white mx-auto mb-3" />
          ...
          <button
            ...
            className={cn(
              "w-full relative bg-white/15 backdrop-blur-md border border-white/30 text-white font-medium py-3 px-6 rounded-xl transition-all",
              "hover:bg-white/25 hover:shadow-[0_8px_40px_rgba(255,255,255,0.2)] focus:outline-none focus:ring-2 focus:ring-white/25",
              "disabled:opacity-50"
            )}
          >
      ...
      return (
        <div className="space-y-4 animate-in fade-in-50 slide-in-from-right-5">
          <div className="text-center mb-6">
            ...
            <p className="text-white/60 text-sm">
              We&apos;ve sent a 6-digit code to <span className="font-medium text-white/90">{formData.email}</span>
            </p>
          </div>
          ...
          <div>
            <div className="relative">
              <input
                ...
                className={cn(
                  "w-full text-center py-3 px-4 bg-white/10 backdrop-blur-md border border-white/15 rounded-xl text-2xl font-mono tracking-widest placeholder:text-white/40 text-white focus:outline-none focus:ring-2 focus:ring-white/25 transition-all",
                  errors.verificationCode ? "border-red-400/70" : "border-white/15"
                )}
                maxLength={6}
    ...
    if (authMode === 'signup' && registrationStep === 'complete') {
      return (
        <div className="text-center space-y-6 animate-in fade-in-50 slide-in-from-right-5">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/15 border border-white/25 text-white">
          ...
          <button
            onClick={onClose}
            className={cn(
              "w-full bg-white/15 backdrop-blur-md border border-white/30 text-white font-medium py-3 px-6 rounded-xl",
              "hover:bg-white/25 focus:outline-none focus:ring-2 focus:ring-white/25"
            )}
          >
            Get Started
          </button>
    ...
    return (
      <div className="space-y-3 animate-in fade-in-50 slide-in-from-right-5">
        {authMode === 'signup' && (
          <div>
            <div className="relative">
        ...
        <div>
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                "w-full pl-10 pr-12 py-3 bg-white/10 backdrop-blur-md border border-white/15 rounded-xl placeholder:text-white/40 text-white focus:outline-none focus:ring-2 focus:ring-white/25 transition-all",
          ...
          <div>
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  "w-full pl-10 pr-12 py-3 bg-white/10 backdrop-blur-md border border-white/15 rounded-xl placeholder:text-white/40 text-white focus:outline-none focus:ring-2 focus:ring-white/25 transition-all",
                  errors.confirmPassword ? "border-red-400/70" : "border-white/15"
                )}
          ...
          {authMode === 'login' ? (
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-white/30 bg-white/10 accent-white"
                aria-describedby={errors.agreeToTerms ? 'terms-error' : undefined}
              />
              <span className="text-sm text-white/70">
                I agree to the{' '}
                <a href="#" className="text-white underline-offset-2 hover:underline transition-colors" onClick={(e) => e.preventDefault()}>
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="text-white underline-offset-2 hover:underline transition-colors" onClick={(e) => e.preventDefault()}>
  ...
  return (
    ...
    >
      {/* Success Message */}
      {successMessage && (
        <div className="mb-4 p-3 bg-white/10 border border-white/20 rounded-xl flex items-center gap-2 animate-in fade-in-0 slide-in-from-top-5">
      ...
      {/* Error Message */}
      {errors.general && (
        <div className="mb-4 p-3 bg-red-500/15 border border-red-400/30 rounded-xl flex items-center gap-2 animate-in fade-in-0 slide-in-from-top-5">
      ...
      {authMode !== 'reset' && (
        <div className="flex bg-white/10 backdrop-blur-md border border-white/15 rounded-xl p-1 mb-4">
          <button
            onClick={() => setAuthMode('login')}
            className={cn(
